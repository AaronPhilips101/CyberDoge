...
async def _restart(message):
    ...
    if "-h" in args:
        ...
        app.restart()
        return await message.edit("```CyberDoge has been updated and the heroku app has been restarted, it should be back online in a few seconds.```")
