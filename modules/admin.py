...
async def handler(event):
    ...
    if reply:
        ...
        if input_str:
            ...
            return await event.edit("`Haha get demoted noob!`")
    try:
...
async def handler(event):
    ...
    if not user:
        ...
        try:
            ...
            await event.edit(f"Haha, {await user_entity(user)} has been demoted, now gib chimken or die!")
        except (Exception) as exc:
            await event.edit(str(exc))
...
async def handler(event):
    ...
    if not participant:
        ...
        try:
            ...
            await event.edit(f"Successfully muted {await user_entity(participant)} cuz he was a retard anyways!")
        except (Exception) as exc:
            await event.edit(str(exc))
...
async def handler(event):
    ...
    if not participant:
        ...
        try:
            await client.edit_permissions(event.chat_id, participant)
            await event.edit(f"Okay, {await user_entity(participant)} is no longer muted cuz idk now die!")
        except (Exception) as exc:
            await event.edit(str(exc))
...
async def handler(event):
    ...
    if not participant:
        ...
        await event.edit("`Get prepared for takeoff!`")
