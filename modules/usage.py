...
async def usage(message):
    await message.edit("`Calling Heroku's bisch..`")
    await asyncio.sleep(0.5)
    if HEROKU_API_KEY is None:
    	await message.edit("`The bisch at heroku says you need to set the HEROKU_API_KEY environment variable first. Checkout .help usage`")
